...
<head>
  ...
  <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.4bc0a340.png">
  <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.3a4ddde5.png">
  <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.14fa0a65.png">

  <title>Luxurypatagoniatravels | Terms of Use</title>

  <link rel="stylesheet" href="/adventure-tours.21711d4b.css">
  <link rel="stylesheet" href="/adventure-tours.b10d73a7.css">

  <script src="/adventure-tours.6300e3bc.js" defer=""></script>
  <script src="/adventure-tours.4d6bcbeb.js" defer=""></script>
  ...
  <div class="container container--big">
    <div class="header__inner">
      ...
      <nav class="nav">
        ...
        <button class="burger" aria-label="Mobile menu" type="button"> <span></span> </button>

        <a class="logo" href="/index.html">
          <img src="/logo.cd13699a.svg" alt="logo" width="257" height="48" loading="lazy">
        </a>
        ...
        <div class="nav__inner">
          ...
          <ul class="nav__list">
            <li class="nav__item">
              <a href="/index.html" class="nav__link false">
                Home
              </a>
            </li>
            <li class="nav__item">
              <a href="/destinations.html" class="nav__link false">
                Destinations
              </a>
            </li>
            ...
            <li class="nav__item">
              <a href="/tours.html" class="nav__link false">
                Tours
              </a>
            </li>

            <li class="nav__item">
              <a href="/guide.html" class="nav__link false">
                Guide
              </a>
            </li>
          </ul>
          ...
          <div class="nav__btns">
            <a class="btn btn--user" href="/sign-up.html">
              Sign Up
            </a>

            <button class="btn btn--reverse request-btn" type="button" formsappId="664339b5544f758068cf14f0">
              Booking
            </button>
          </div>
        </div>
...
<script>const startHeightValue = ()=>{
    ...
    if (scrollPosition > 0) pageHeader.classList.add("header--scroll");
    else pageHeader.classList.remove("header--scroll");
};
...
startHeightValue();
  ...
  <div class="container container--big">
    <h1 class="title title--reverse">Privacy Policy</h1>

    <div class="policy__inner">
      <div class="policy__content">
        <p>Updated 10 July, 2023</p>
      </div>
      ...
      <div class="policy__content">
        <p>
          ...
          the “Luxury Patagonia Travels” website (“WebSite” or “Service”) and
          any of its related products and services (collectively, “Services”) is
          ...
          agreement between you (“User”, “you” or “your”) and Luxury Patagonia
          Travels ( “we”, “us” or “our”). By accessing and using the website and
          Services, you acknowledge that you have read, understood, and agree to
          be bound by the terms of this Agreement. This Policy does not apply to
      ...
      <div class="policy__content">
        ...
        <p>
          When you use the website, our servers automatically record information
          ...
          for in the website, access times and dates, and other statistics.
        </p>
        ...
        <p>
          ...
          usage of the website and Services. This statistical information is not
      ...
      <div class="policy__content">
        ...
        <p>
          ...
          use some of the features in the website, you may be asked to provide
          ...
          to us when you sign up, or fill any online forms in the website. When
          required, this information may include contact information such as
          email address, address, etc.
        </p>
        ...
        <p>
          No mobile information will be shared or sold to third
          parties/affiliates for marketing/promotional purposes. We do not
          express or imply to other companies or firms that you have given
          subscriber opt-in permission to someone other than Luxury Patagonia
          Travels. However, Luxury Patagonia Travels may disclose personal
          information that we collect or you provide as described in this Policy
          (i) to fulfill the purpose for which you provide your information;
          (ii) for any other purpose disclosed by Luxury Patagonia Travels when
          you provide us your information; (iii) to protect the rights of Luxury
          Patagonia Travels and/or any third parties; (iv) to third-party
          service providers who assist us in operating this Website, conducting
          our business, or serving our users, so long as such information is
          kept confidential; (v) to comply with any court order, law, legal
          process, and/or government or regulatory request; (vi) as part of a
          liquidation or bankruptcy proceeding, to a buyer or other successor in
          the event of a merger, reorganization, dissolution, or divestiture of
          some or all of Luxury Patagonia Travels’s assets. We use the
          information that we collect about you through your interaction with
          this Website as well as information that you provide to us, including
          personal information. This information is used (i) to present the
          contents of this Website to you; (ii) to deliver services that you
          have requested; (iii) to determine whether to extend an offer; (iv) to
          communicate with you via telephone, email, postal mail, and/or text
          message from us; (v) to display advertising tailored to your interests
          or background; (vi) perform data and statistical analysis from your
          use of this Website; (vii) enforce our Terms and Condition; and (viii)
          to perform any other functions otherwise described to you when you
      ...
      <div class="policy__content">
        ...
        <p>
          ...
          certain data protection rights and Luxury Patagonia Travels aims to
          take reasonable steps to allow you to correct, amend, delete, or limit
          the use of your Personal Information. If you wish to be informed what
        ...
        <ul>
          ...
          <li>
            ...
            Luxury Patagonia Travels relied on your consent to process your
      ...
      <div class="policy__content">
        ...
        <p>
          Any requests to exercise your rights can be directed to Luxury
          Patagonia Travels through the contact details provided in this
      ...
      <div class="policy__content">
        ...
        <p>
          ...
          ways at our discretion, such as through contact information you have
      ...
      <div class="policy__content">
        ...
        <p>
          ...
          rights and your Personal Information, you may send an email
          <a href="mailto:contact@luxurypatagoniatravels.com">contact@luxurypatagoniatravels.com</a>
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="container container--big">
    ...
    <h3>
      <span>Plan your next tour</span> with LuxuryPatagonia Travels!
    </h3>
  ...
  <div class="container container--big">
    <div class="footer__main">
      <div class="footer__contact-logo">
        ...
        <span>Email:</span>
        <a class="footer__contact" href="mailto:contact@luxurypatagoniatravels.com">contact@luxurypatagoniatravels.com</a>
      </div>

      <div class="footer__inner">
        <p>Newsletter</p>

        <form class="contact contact__form">
    ...
    <div class="footer__bottom">
      <p>LuxuryPatagonia Travels © 2024. All Rights Reserved</p>
...
<script src="https://forms.app/static/embed.js" async="" defer="" onload="new formsapp('664339b5544f758068cf14f0', 'popup', {'overlay':'rgba(45,45,45,0.5)','button':{'color':'','text':'Booking'},'width':'800px','height':'600px','openingAnimation':{'entrance':'animate__fadeIn','exit':'animate__fadeOut'}});"></script>
